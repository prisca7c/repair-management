...
import { formatMoney, customerFullName } from "@/lib/format";
...
export default async function TechnicianPaymentsPage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-xl font-semibold text-slate-900">Technician payments</h1>
      <p className="text-sm text-slate-500">Repairs with an unpaid external technician.</p>
